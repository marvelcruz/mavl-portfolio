...
export const stories = {
  ...
  desc: "The values and principles behind how I support teams, build systems, and show up professionally.",
  values: [
    {
      title: "Systems Thinking",
      desc: "I look for the root cause of operational friction and build structures that prevent it from recurring.",
    },
    {
      title: "Quiet Reliability",
      desc: "I do what I say I will do, on time, without needing to be chased. Dependability is my baseline.",
    },
    {
      title: "Remote-First Mindset",
      desc: "I have worked remotely for 5+ years and understand how to communicate, execute, and stay accountable across time zones.",
    },
  ],
};
